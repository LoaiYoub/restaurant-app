                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="mt-4 space-x-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_vegetarian" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    {{ old('is_vegetarian') ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-600">Vegetarian</span>
                            </label>

                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_gluten_free" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    {{ old('is_gluten_free') ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-600">Gluten Free</span>
                            </label>

                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_featured" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
